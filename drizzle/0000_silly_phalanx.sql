...
CREATE TYPE "public"."choir_status" AS ENUM('CHOIR_REQUIRED', 'NO_CHOIR_NEEDED', 'SAID_SERVICE_ONLY', 'NO_SERVICE');--> statement-breakpoint
...
CREATE TYPE "public"."music_slot_type" AS ENUM('HYMN', 'PSALM', 'ANTHEM', 'MASS_SETTING_KYRIE', 'MASS_SETTING_GLORIA', 'MASS_SETTING_SANCTUS', 'MASS_SETTING_AGNUS', 'MASS_SETTING_GLOBAL', 'ORGAN_VOLUNTARY_PRE', 'ORGAN_VOLUNTARY_POST', 'ORGAN_VOLUNTARY_OFFERTORY', 'CANTICLE_MAGNIFICAT', 'CANTICLE_NUNC_DIMITTIS', 'RESPONSES', 'GOSPEL_ACCLAMATION', 'OTHER');--> statement-breakpoint
CREATE TYPE "public"."reading_position" AS ENUM('OLD_TESTAMENT', 'PSALM', 'NEW_TESTAMENT', 'GOSPEL', 'CANTICLE');--> statement-breakpoint
CREATE TYPE "public"."rite" AS ENUM('CW', 'BCP', 'COMMON', 'CUSTOM');--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "church_service_patterns" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"church_id" uuid NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "eucharistic_prayers" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"key" text NOT NULL,
	"name" text NOT NULL,
	"rite" "rite" NOT NULL,
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "eucharistic_prayers_key_unique" UNIQUE("key")
);
--> statement-breakpoint
CREATE TABLE "hymns" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE "services" (
	...
	"notes" text,
	"eucharistic_prayer" text,
	"eucharistic_prayer_id" uuid,
	"collect_id" uuid,
	"collect_override" text,
	"include_reading_text" boolean DEFAULT true NOT NULL,
	"sheet_mode" text DEFAULT 'summary' NOT NULL,
	"liturgical_overrides" json DEFAULT '{}'::json,
	"choir_status" "choir_status" DEFAULT 'CHOIR_REQUIRED' NOT NULL,
	"default_mass_setting_id" uuid,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "church_template_sections" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"church_template_id" uuid NOT NULL,
	"section_key" text NOT NULL,
	"title" text NOT NULL,
	"major_section" text,
	"position_order" integer NOT NULL,
	"liturgical_text_id" uuid,
	"music_slot_type" "music_slot_type",
	"placeholder_type" text,
	"optional" boolean DEFAULT false NOT NULL,
	"allow_override" boolean DEFAULT false NOT NULL
);
--> statement-breakpoint
CREATE TABLE "church_templates" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"church_id" uuid NOT NULL,
...
CREATE TABLE "liturgical_texts" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "liturgical_texts_key_unique" UNIQUE("key")
);
--> statement-breakpoint
...
CREATE TABLE "service_type_templates" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "service_type_templates_service_type_unique" UNIQUE("service_type")
);
--> statement-breakpoint
...
ALTER TABLE "church_service_patterns" ADD CONSTRAINT "church_service_patterns_church_id_churches_id_fk" FOREIGN KEY ("church_id") REFERENCES "public"."churches"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "collects" ADD CONSTRAINT "collects_liturgical_day_id_liturgical_days_id_fk" FOREIGN KEY ("liturgical_day_id") REFERENCES "public"."liturgical_days"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "collects" ADD CONSTRAINT "collects_church_id_churches_id_fk" FOREIGN KEY ("church_id") REFERENCES "public"."churches"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "invites" ADD CONSTRAINT "invites_church_id_churches_id_fk" FOREIGN KEY ("church_id") REFERENCES "public"."churches"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "services" ADD CONSTRAINT "services_eucharistic_prayer_id_eucharistic_prayers_id_fk" FOREIGN KEY ("eucharistic_prayer_id") REFERENCES "public"."eucharistic_prayers"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "services" ADD CONSTRAINT "services_collect_id_collects_id_fk" FOREIGN KEY ("collect_id") REFERENCES "public"."collects"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "services" ADD CONSTRAINT "services_default_mass_setting_id_mass_settings_id_fk" FOREIGN KEY ("default_mass_setting_id") REFERENCES "public"."mass_settings"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "church_template_sections" ADD CONSTRAINT "church_template_sections_church_template_id_church_templates_id_fk" FOREIGN KEY ("church_template_id") REFERENCES "public"."church_templates"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "church_template_sections" ADD CONSTRAINT "church_template_sections_liturgical_text_id_liturgical_texts_id_fk" FOREIGN KEY ("liturgical_text_id") REFERENCES "public"."liturgical_texts"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "church_templates" ADD CONSTRAINT "church_templates_church_id_churches_id_fk" FOREIGN KEY ("church_id") REFERENCES "public"."churches"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "church_templates" ADD CONSTRAINT "church_templates_base_template_id_service_type_templates_id_fk" FOREIGN KEY ("base_template_id") REFERENCES "public"."service_type_templates"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "hymn_verses" ADD CONSTRAINT "hymn_verses_hymn_id_hymns_id_fk" FOREIGN KEY ("hymn_id") REFERENCES "public"."hymns"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "service_sections" ADD CONSTRAINT "service_sections_service_id_services_id_fk" FOREIGN KEY ("service_id") REFERENCES "public"."services"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "service_sections" ADD CONSTRAINT "service_sections_liturgical_text_id_liturgical_texts_id_fk" FOREIGN KEY ("liturgical_text_id") REFERENCES "public"."liturgical_texts"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "service_sections" ADD CONSTRAINT "service_sections_music_slot_id_music_slots_id_fk" FOREIGN KEY ("music_slot_id") REFERENCES "public"."music_slots"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "template_sections" ADD CONSTRAINT "template_sections_template_id_service_type_templates_id_fk" FOREIGN KEY ("template_id") REFERENCES "public"."service_type_templates"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "template_sections" ADD CONSTRAINT "template_sections_liturgical_text_id_liturgical_texts_id_fk" FOREIGN KEY ("liturgical_text_id") REFERENCES "public"."liturgical_texts"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "availability_service_idx" ON "availability" USING btree ("service_id");--> statement-breakpoint
...
CREATE INDEX "membership_user_idx" ON "church_memberships" USING btree ("user_id");--> statement-breakpoint
CREATE UNIQUE INDEX "church_service_pattern_unique" ON "church_service_patterns" USING btree ("church_id","day_of_week","service_type");--> statement-breakpoint
CREATE INDEX "collect_liturgical_day_idx" ON "collects" USING btree ("liturgical_day_id");--> statement-breakpoint
CREATE UNIQUE INDEX "collect_unique" ON "collects" USING btree ("liturgical_day_id","rite","church_id");--> statement-breakpoint
...
CREATE INDEX "music_slot_service_idx" ON "music_slots" USING btree ("service_id");--> statement-breakpoint
CREATE INDEX "perf_log_church_idx" ON "performance_logs" USING btree ("church_id");--> statement-breakpoint
CREATE INDEX "perf_log_date_idx" ON "performance_logs" USING btree ("date");--> statement-breakpoint
CREATE INDEX "reading_liturgical_day_idx" ON "readings" USING btree ("liturgical_day_id");--> statement-breakpoint
CREATE UNIQUE INDEX "rota_unique" ON "rota_entries" USING btree ("service_id","user_id");--> statement-breakpoint
CREATE INDEX "rota_service_idx" ON "rota_entries" USING btree ("service_id");--> statement-breakpoint
CREATE UNIQUE INDEX "service_unique" ON "services" USING btree ("church_id","liturgical_day_id","service_type");--> statement-breakpoint
CREATE INDEX "service_church_idx" ON "services" USING btree ("church_id");--> statement-breakpoint
CREATE UNIQUE INDEX "church_template_unique" ON "church_templates" USING btree ("church_id","base_template_id");--> statement-breakpoint
CREATE UNIQUE INDEX "hymn_verse_unique" ON "hymn_verses" USING btree ("hymn_id","verse_number");--> statement-breakpoint
CREATE INDEX "service_section_service_idx" ON "service_sections" USING btree ("service_id");